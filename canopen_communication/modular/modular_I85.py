...
class I85(Canopen_control_init):
    ...
    def _eds_configure(self):
        ...
        # self.node.sdo[0x2111].raw = 96  # Continuous current limit
        # self.node.sdo[0x2112].raw = 1299  # Time at peak current limit
        ...
        # self.node.sdo[0x2121].raw = 955187 # Trajectory jerk limit
        # self.node.sdo[0x6083].raw = 238797 # Profile Acceleration
        # self.node.sdo[0x6084].raw = 238797 # Profile Dcceleration
        # self.node.sdo[0x6085].raw = 238797 # Quick Stop Deceleration

        # #profile velocity mode
        # self.node.sdo[0x60f9][0x1].raw = 337  # Proportional gain for velocity loop
        # self.node.sdo[0x60f9][0x2].raw = 106  # Integral gain for velocity loop

        # #profilee torque mode
        # self.node.sdo[0x60f6][0x1].raw = 160  # Proportional gain for current loop
        # self.node.sdo[0x60f6][0x2].raw = 119  # Integral gain for current loop
