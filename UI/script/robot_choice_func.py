...
sys.path.append(rp.get_path('ui') + "/script/wheel_bipedal_7d")
...
from wheel_bipedal_7d_mode_set_func import wheel_bipedal_7d_mode_set_func
...
class Robot_choice_func(QMainWindow,Ui_MainWindow):
    ...
    def wheel_bipedal7d(self):
        self.windows_wheel_bipedal_7d_mode_set = wheel_bipedal_7d_mode_set_func(self.simulation)
        self.windows_wheel_bipedal_7d_mode_set.sin_close.connect(self.close_wheel_bipedal7d)
        self.form.hide()
        self.windows_wheel_bipedal_7d_mode_set.show()
        pass
    ...
    def close_arm5d_mode_set(self):
        ...
        del self.windows_arm5d_mode_set
        self.form.show()

    def close_wheel_bipedal7d(self):
        self.windows_wheel_bipedal_7d_mode_set.close()
        del self.windows_wheel_bipedal_7d_mode_set
        self.form.show()
        pass
