...
from arm5d_teach_record import Ui_arm5d_teach_record

class Arm5d_teach_record_func(QWidget,Ui_arm5d_teach_record):

    def __init__(self):
        super(Arm5d_teach_record_func,self).__init__()
        self.setupUi(self)

        self.__teach_data_index = 0
        self.__file_path = rp.get_path('ui') + "/teach_data/teach_data_{0}.txt".format(self.__teach_data_index)
        self.__I1_pos,self.__T2_pos,self.__T3_pos,self.__i4_pos,self.__t5_pos = [0,0,0,0,0]
        self.__click_line = -1
        self.__clear = False
    ...
    def take_record(self):
        if self.__clear:
            ...
            self.__clear = False
        self.listWidget.addItem("{0},{1},{2},{3},{4}".format(self.__I1_pos,self.__T2_pos,self.__T3_pos,self.__i4_pos,self.__t5_pos))
        pass
    ...
    def get_joint_data(self,data):
        self.__I1_pos,self.__T2_pos,self.__T3_pos,self.__i4_pos,self.__t5_pos = data 
