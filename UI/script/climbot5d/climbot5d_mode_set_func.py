...
from climbot5d_data_show_func import climbot5d_Data_show_func
from climbot5d_descartes_control_func import Climbot5d_descartes_control_func
...
class climbot5d_Mode_set_func(QWidget,Ui_climbot5d_Mode_Set,Climbot5d_Variable):
    # 关闭当前界面信号
    ...
    def __init__(self,simulation=False):
        ...
        rospy.init_node('Climbot5d_control')
        # this publisher was to sent joint points by positive algorithm to getting the descartes datas.
        self.pub_wjc = rospy.Publisher('climbot5d_Joint_point', Float64MultiArray, queue_size=5)
        # this subscriber was to receive the descartes data.
        self.sub_wjc = rospy.Subscriber('climbot5d_Positive_solution', Float64MultiArray,self.positive_solution_callback)
        ...
        # self.simulation_joint_command.name = ["G0_Joint", "I1_Joint", "T2_Joint", "T3_Joint", "T4_Joint", "I5_Joint", "G6_Joint"]
        ...
        if not self.simulation:
            ...
            # 夹持器连接
            self.sin_G0_command.connect(self.sent_joint_data.new_G0_joint_data)
            self.sin_G6_command.connect(self.sent_joint_data.new_G6_joint_data)
            # 离线数据窗口暂停连接
        ...
        self.Descartes_X = 0.5864
        self.Descartes_Y = 0
        self.Descartes_Z = 0
        self.Descartes_RX = 0
        self.Descartes_RY = 0
        self.Descartes_RZ = 3.141592654
    ...
    def joint_control(self):
        ...
        self.windows_joint_control.sin_G0_data.connect(self.sent_G0_torque)
        self.windows_joint_control.sin_G6_data.connect(self.sent_G6_torque)
        ...
        self.windows_joint_control.lineEdit.setText('{0}'.format(self.G0_value))
        self.windows_joint_control.lineEdit_2.setText("{0}".format(round(degrees(self.I1_value - self.I1_error),3)))
        self.windows_joint_control.lineEdit_3.setText("{0}".format(round(degrees(self.T2_value - self.T2_error+ 1.57079),3)))
        self.windows_joint_control.lineEdit_5.setText("{0}".format(round(degrees(self.T3_value - self.T3_error),3)))
        self.windows_joint_control.lineEdit_4.setText("{0}".format(round(degrees(self.T4_value - self.T4_error+ 1.57079),3)))
        self.windows_joint_control.lineEdit_6.setText("{0}".format(round(degrees(self.I5_value - self.I5_error),3)))
        self.windows_joint_control.lineEdit_7.setText('{0}'.format(self.G6_value))
    ...
    def decartes_control(self):
        ...
        self.windows_decartes_control = Climbot5d_descartes_control_func()
        ...
        self.windows_decartes_control.sin_G0_data.connect(self.sent_G0_torque)
        self.windows_decartes_control.sin_G6_data.connect(self.sent_G6_torque)
        ...
        self.windows_decartes_control.lineEdit.setText('{0}'.format(self.G0_value))
        self.windows_decartes_control.lineEdit_2.setText('{0}'.format(round(degrees(self.I1_value - self.I1_error),3)))
        self.windows_decartes_control.lineEdit_3.setText('{0}'.format(round(degrees(self.T2_value - self.T2_error + 1.57079),3)))
        self.windows_decartes_control.lineEdit_5.setText('{0}'.format(round(degrees(self.T3_value - self.T3_error),3)))
        self.windows_decartes_control.lineEdit_4.setText('{0}'.format(round(degrees(self.T4_value - self.T4_error + 1.57079),3)))
        self.windows_decartes_control.lineEdit_6.setText('{0}'.format(round(degrees(self.I5_value - self.I5_error),3)))
        self.windows_decartes_control.lineEdit_7.setText('{0}'.format(self.G6_value))
    ...
    def data_show(self):
        ...
        self.windows_data_show = climbot5d_Data_show_func()
        ...
        self.windows_data_show.sin_G0_data.connect(self.sent_G0_torque)
        self.windows_data_show.sin_G6_data.connect(self.sent_G6_torque)
    ...
    def set_zero(self):
        ...
        self.T4_error = self.T4_value
        self.I5_error = self.I5_value
        
        if self.G6_value == self.open_gripper:
            self.joint_point.data[0] = 1  # G0 close and G6 open
        elif self.G0_value == self.open_gripper:
            self.joint_point.data[0] = 0  # G6 open and G6 close
        self.joint_point.data[1:] = [self.I1_value,self.T2_value,self.T3_value,self.T4_value,self.I5_value]
        ...
        self.windows_joint_control.lineEdit_4.setText("{0}".format(round(degrees(self.T4_value - self.T4_error + 1.57079),3)))            
        self.windows_joint_control.lineEdit_6.setText("{0}".format(round(degrees(self.I5_value - self.I5_error),3)))
        self.X_error = self.positive_solution.data[0] - 0.5864 
        self.Y_error = self.positive_solution.data[1]
        self.Z_error = self.positive_solution.data[2]
        self.RX_error = self.positive_solution.data[3]
        self.RY_error = self.positive_solution.data[4]
        self.RZ_error = self.positive_solution.data[5] - 3.141592654

        self.sin_set_zero_position.emit([self.I1_error,self.T2_error,self.T3_error,self.T4_error,self.I5_error])
    
    # 接收关节数据反馈
    def joint_control_feedback_data(self,data):
        try:
            self.G0_value = data[0]
            self.I1_value = data[1]
            self.T2_value = data[2]
            self.T3_value = data[3] 
            self.T4_value = data[4]
            self.I5_value = data[5]
            self.G6_value = data[6]
            self.windows_joint_control.lineEdit.setText('{0}'.format(self.G0_value))
            self.windows_joint_control.lineEdit_2.setText("{0}".format(round(degrees(self.I1_value - self.I1_error),3)))
            self.windows_joint_control.lineEdit_3.setText("{0}".format(round(degrees(self.T2_value - self.T2_error+ 1.57079),3)))
            self.windows_joint_control.lineEdit_5.setText("{0}".format(round(degrees(self.T3_value - self.T3_error),3)))
    ...
    def offline_control_feedback_data(self,data):
        try:
            self.G0_value ,self.I1_value ,self.T2_value ,self.T3_value ,self.T4_value ,self.I5_value ,self.G6_value = data
            self.__get_positive_value()
            self.sin_sent_data_to_show_monitor.emit([self.G0_value ,self.I1_value ,self.T2_value ,self.T3_value ,self.T4_value ,self.I5_value ,self.G6_value,\
